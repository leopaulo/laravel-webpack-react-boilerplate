...
class Handler extends ExceptionHandler
{
	...
	private function shouldNotBeHandled($request, Throwable $exception)
	{
	...
	{
		if ($this->shouldNotBeHandled($request, $exception)) {
			return parent::render($request, $exception);
		} else {
			$responseFormatterService = new ResponseFormatterService();

			return $responseFormatterService->error($exception);
		}
	}
}
